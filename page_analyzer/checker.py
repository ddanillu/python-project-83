...
def checking_url(url):
    ...
    Параметры:
    - url: объект с атрибутом `name`, содержащим URL-строку (
    например, url.name = 'https://example.com'
    ).

    Возвращаемые значения:
    - Возвращает словарь, содержащий:
        - 'code': HTTP статус код (int).
        - 'h1': содержимое тега <h1>/пустую строку.
        - 'title': содержимое тега <title>/пустую строку.
        - 'meta_description': содержимое мета-тега description/пустую строку.
    ...
    headers = {"User-Agent": "Page Analyzer Bot"}
    try:
